...
public class AwesomePasswordChecker {
  ...
  /**
   * Instance unique de la classe pour le singleton.
   */
  private static AwesomePasswordChecker instance;

  /**
   * liste des centres de clusters utilisée pour les calculs.
   */
  ...
  public static AwesomePasswordChecker getInstance() throws IOException {
    if (instance == null) {
      InputStream is = AwesomePasswordChecker.class.getClassLoader().getResourceAsStream(
  ...
  /**
   * Constructeur privé qui initialise les centres des clusters à partir d'un flux d'entrée.
   *
   * @param is le flux d'entrée contenant les données des clusters.
   * @throws IOException si une erreur d'entrée/sortie se produit.
   */
  ...
  /**
   * Calcule un tableau de masques pour un mot de passe donné.
   *
